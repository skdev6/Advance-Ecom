...
<div class='row single-product'>
	<div class='col-md-3 sidebar'>
		<div class="sidebar-module-container">
			<div class="home-banner outer-top-n"> <img src="{{asset('frontend')}}/assets/images/banners/LHS-banner.jpg" alt="Image"> </div>
			<div class="sidebar-widget hot-deals wow fadeInUp outer-top-vs">
				...
				<div class="owl-carousel sidebar-carousel custom-carousel owl-theme outer-top-xs">
					<div class="item">
                        ...
                        $600.00
                    </span> <span class="price-before-discount">$800.00</span> </div>
							</div>
				...
				<div class="col-xs-12 col-sm-6 col-md-5 gallery-holder">
					<div class="product-item-holder size-big single-product-gallery small-gallery">
						<div id="owl-single-product">
                            @foreach ($multi_image as $multi_image_item)
                                <div class="single-product-gallery-item" id="slide-{{$multi_image_item->id}}">
                                    <a data-lightbox="image-1" data-title="Gallery" href="{{asset($multi_image_item->product_name)}}"> <img class="img-responsive" alt="" src="{{asset($multi_image_item->product_name)}}" data-echo="{{asset($multi_image_item->product_name)}}" /> </a>
                                </div> 
                            @endforeach
						</div>
						...
						<div class="single-product-gallery-thumbs gallery-thumbs">
							<div id="owl-single-product-thumbnails">
                                @foreach ($multi_image as $multi_image_item)
                                    <div class="item">
                                        <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="{{$multi_image_item->id}}" href="#slide-{{$multi_image_item->id}}"> <img class="img-responsive" width="85" alt="" src="{{asset($multi_image_item->product_name)}}" data-echo="{{asset($multi_image_item->product_name)}}" /> </a>
                                    </div>
                                @endforeach
							</div>
					...
					<div class="product-info">
						...
						<div class="stock-container info-container m-t-10">
							<div class="row">
								...
								<div class="col-sm-9">
									<div class="stock-box"> <span class="value">In Stock</span> </div>
								</div>
							</div>
							<!-- /.row -->
						</div>
						...
						<div class="price-container info-container m-t-20">
							<div class="row">
								<div class="col-sm-6">
									<div class="price-box"> <span class="price">৳{{session()->get('language') == 'bangla' ? change_bgngla($product->selling_price) : $product->selling_price}}</span> <span class="price-strike">
						...
						<div class="quantity-container info-container">
							<div class="row">
								...
								<div class="col-sm-7"> <a href="#" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i> ADD TO CART</a> </div>
							</div>
							<!-- /.row -->
						</div>
						<!-- /.quantity-container -->
					...
					<div class="tab-content">
												...
												<div class="row">
													<div class="col-sm-6">
														<div class="form-group">
															...
															<input type="text" class="form-control txt" id="exampleInputName" placeholder=""> </div>
														<!-- /.form-group -->
														<div class="form-group">
															<label for="exampleInputSummary">Summary <span class="astk">*</span></label>
															<input type="text" class="form-control txt" id="exampleInputSummary" placeholder=""> </div>
														<!-- /.form-group -->
													</div>
													<div class="col-md-6">
														<div class="form-group">
						...
						<div id="tags" class="tab-pane">
							<div class="product-tag">
								...
								<form role="form" class="form-inline form-cnt">
									<div class="form-container">
										<div class="form-group">
											...
											<input type="email" id="exampleInputTag" class="form-control txt"> </div>
								...
								<form role="form" class="form-inline form-cnt">
									<div class="form-group">
										<label>&nbsp;</label> <span class="text col-md-offset-3">Use spaces to separate tags. Use single quotes (') for phrases.</span> </div>
								</form>
								<!-- /.form-cnt -->
							</div>
							<!-- /.product-tab -->
					...
					<div class="products">
						<div class="product">
							...
							<div class="product-info text-left">
								...
								<div class="product-price"> <span class="price">
        $650.99				</span> <span class="price-before-discount">$ 800</span> </div>
								<!-- /.product-price -->
							</div>
							<!-- /.product-info -->
							<div class="cart clearfix animate-effect">
